...
sudo apt-get install nginx php7.0-cli php7.0-curl php7.0-dev php7.0-fpm php7.0-gd php7.0-mysql php7.0-mcrypt php7.0-opcache php-mbstring mariadb-server mariadb-client unzip varnish ufw -y
